  ...
  void _loadSettings() async {
    ...
    this.setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'wss://fone.ledunia.com:7443';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'sip:1000@139.59.162.221';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'Flutter SIP UA';
      _passwordController.text = _preferences.getString('tempoWild');
      _authorizationUserController.text = _preferences.getString('1000');
    });
  }
